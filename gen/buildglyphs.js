...
exports.build = r1_buildFont = function _r1_t17(r261_para, r261_recursive, r261_recursiveCodes) {
    ...
    (function _r261_t19() {
        ...
        if (!r279_currentGlyph)
            return void 0;
        if (r261_glyphList[r261_glyphList.length - 1].name === '.WF.gen/buildglyphs.ptl.1')
            r261_glyphList.pop();
    ...
    }.call(r261_xn$createglyph$7Hrq('.WF.gen/buildglyphs.ptl.1', r1_xn$donothing$2Lrc0b)));
    (function _r261_t20() {
        var _r290_t0 = this;
        var r290_currentGlyph = _r290_t0;
        if (!r290_currentGlyph)
            return void 0;
        if (r261_glyphList[r261_glyphList.length - 1].name === '.WF.gen/buildglyphs.ptl.2')
            r261_glyphList.pop();
    ...
    }.call(r261_xn$createglyph$7Hrq('.WF.gen/buildglyphs.ptl.2', r1_xn$donothing$2Lrc0b)));
    (function _r261_t21() {
        var _r294_t0 = this;
        var r294_currentGlyph = _r294_t0;
        if (!r294_currentGlyph)
            return void 0;
        if (r261_glyphList[r261_glyphList.length - 1].name === '.WF.gen/buildglyphs.ptl.3')
            r261_glyphList.pop();
    ...
    }.call(r261_xn$createglyph$7Hrq('.WF.gen/buildglyphs.ptl.3', r1_xn$donothing$2Lrc0b)));
    (function _r261_t22() {
        var _r298_t0 = this;
        var r298_currentGlyph = _r298_t0;
        if (!r298_currentGlyph)
            return void 0;
        if (r261_glyphList[r261_glyphList.length - 1].name === '.WF.gen/buildglyphs.ptl.4')
            r261_glyphList.pop();
    ...
    }.call(r261_xn$createglyph$7Hrq('.WF.gen/buildglyphs.ptl.4', r1_xn$donothing$2Lrc0b)));
    var r261_capture = {
